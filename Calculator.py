    ...
    def hl(v1, v2):
        ...
        if v1 > v2:
            ...
            while (int(v2) % int(v1)) != 0:
                ...
                v1 = c
            hcf = v1
        sum = "HCF:" + str(hcf) + " LCM:" + str(int(n) * int(nv1) / int(hcf))
        label_sum.configure(fg="white")
        label_sum.configure(background="black")
        label_sum.configure(text=sum)
...
def tri():
    ...
    def perimeter(v1, v4, v5):
        # print(v1, v2)
        # global sum
        sum = (float(v1) + float(v4)) + float(v5)
        label_sum.configure(fg="white")
        label_sum.configure(background="black")
        label_sum.configure(text=sum)
    ...
    def volume(v1, v2, v3):
        # print(v1, v2)
        # global sum
        sum = ((float(v1) * float(v2)) / 2) * float(v3)
        label_sum.configure(fg="white")
        label_sum.configure(background="black")
        label_sum.configure(text=sum)
...
def fra():
    ...
    def volume(v1):
        ...
        # global sum
        # v1=int(v1)
        sum = (4 / 3) * (22 / 7) * (int(v1) * int(v1) * int(v1))
        label_sum.configure(fg="white")
        label_sum.configure(background="black")
        label_sum.configure(text=sum)
